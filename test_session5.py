...
def test_pos_number_squared():
    output, avg_time = session5.time_it(squared_power_list, 2, start=0, end=5, repetitions=10000)
...
def test_neg_decimal_squared():
    output, avg_time = session5.time_it(squared_power_list, -1.5, start=0, end=5, repetitions=10000)
    assert output == [1.0, -1.5, 2.25, -3.375, 5.0625], 'Square List incorrect'
    assert avg_time > 0, 'Average time should be > 0'
